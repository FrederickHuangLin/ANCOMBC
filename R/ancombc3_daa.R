#' @title Analysis of Compositions of Microbiomes with Bias Correction 3
...
#' covariate of interest (e.g., group).
#'
...
#'
#' @export
ancombc3_daa = function(data, taxa_are_rows = TRUE,
                        ...
                        group = NULL, alpha = 0.05, n_cl = 1, verbose = TRUE,
    ...
    # 2. ANCOM-BC3 differential abundance analysis
    res_main = .ancombc3_core(data = O1, aggregate_data = O2,
    ...
    if (pseudo_sens) {
        ...
        ss_list = lapply(pseudo_list, function(pseudo_count) {
            res_pseudo = .ancombc3_core(data = O1, aggregate_data = O2,
                                        meta_data = meta_data,
                                        fix_formula = fix_formula,
                                        rand_formula = rand_formula,
                                        p_adj_method = p_adj_method,
