...
bias_est = function(beta, var_hat, tol, max_iter, n_taxa) {
    ...
    for (i in seq_along(delta_em)) {
        ...
        # Initials
        pi0_0 = 0.75; pi1_0 = 0.125; pi2_0 = 0.125
        ...
        pi1 = fiuo_em$pi1; pi2 = fiuo_em$pi2; l1 = fiuo_em$l1; l2 = fiuo_em$l2
        kappa1 = fiuo_em$kappa1; kappa2 = fiuo_em$kappa2
        # Cluster 0
        ...
        nu = nu0; nu[C1] = nu[C1] + kappa1; nu[C2] = nu[C2] + kappa2
        wls_deno = sum(1 / nu)
