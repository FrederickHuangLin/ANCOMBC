...
#'
#' @details Taxa with structural zeros are retained in the primary result, with
#' their standard errors, p-values, and adjusted p-values set to 0 and
#' \code{diff_abn} set to TRUE for each level of the \code{group} variable whose
#' structural zero status differs from that of the reference level. The
