...
## 4.9 Run `ancombc2` function using the `tse` object
...
## 4.10 Run `ancombc2` function by directly providing the abundance and metadata
...
## 5.8 Run `ancombc2` function using the `tse` object
...
## 5.9 Run `ancombc2` function by directly providing the abundance and metadata
