...
Aggregation to a higher taxonomic level is not available for this input type: the `tax_level` and `assay_name` arguments are ignored and are therefore omitted below. Aggregate the abundance data to the taxonomic level of interest before the call, or supply a `phyloseq` or `tse` object, for which the function performs the aggregation.
